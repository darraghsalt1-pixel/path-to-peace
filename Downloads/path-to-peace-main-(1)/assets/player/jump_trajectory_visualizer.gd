...
#TODO add credits to gdquest for this script.
...
func _update_curve() -> void:
	...
	var max_speed := calculate_max_speed(parent_character.jump_horizontal_distance, parent_character.jump_time_to_peak, parent_character.jump_time_to_descend)
	...
	var fall_gravity := calculate_fall_gravity(parent_character.jump_height, parent_character.jump_time_to_descend)
